...
from src.protocol.response_schemas import AckResponse, GameStartedNotification
from src.game.game import Game


class GameSession:
    def __init__(self, player1, player2, connection_manager):
        self.connection_manager = connection_manager
        self.game = Game()
        self.game.add_player(player1)
        self.game.add_player(player2)
        logging.info(f"New game session started between {player1.addr} and {player2.addr}")
    ...
    def handle_move(self, msg):
        ...
        if self.game.check_winner():
            ...
            self.connection_manager.notify_clients({ "type": "game_over", "winner": winner_name })
    ...
    def handle_quit(self, msg):
        ...
        self.connection_manager.notify_clients({ "type": "quit", "user": msg.request.user })
